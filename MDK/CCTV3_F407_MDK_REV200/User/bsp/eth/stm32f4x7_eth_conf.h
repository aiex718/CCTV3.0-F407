...
#ifdef USE_Delay
#include "bsp/sys/systime.h" /* Header file where the Delay function prototype is exported */
...
#define CUSTOM_DRIVER_BUFFERS_CONFIG
    ...
    #define ETH_RXBUFNB 3                       /* 4 Rx buffers of size ETH_RX_BUF_SIZE */
    #define ETH_TXBUFNB 7                       /* 4 Tx buffers of size ETH_TX_BUF_SIZE */
#endif
...
#define LAN8742A_RESET_DELAY ((uint32_t)0x00000064)
#else
/* PHY Reset delay */
