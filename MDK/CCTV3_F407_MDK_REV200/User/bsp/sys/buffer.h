...
{                                                                                   \
    ...
    {                                                                               \
        ...
        BSP_MEMCPY(self->w_ptr,data,w_len);                                         \
        data+=w_len;                                                                \
...
{                                                                                   \
    ...
    {                                                                               \
        ...
        BSP_MEMCPY(data,self->r_ptr,r_len);                                         \
        data+=r_len;                                                                \
...
#define Buffer_Queue_QuickPush(self,x) \
    do{ *((self)->w_ptr)=(x);__Buffer_Queue_IncPtr((self),(self)->w_ptr);}while(0)
#define Buffer_Queue_QuickPop(self,o) \
    do{(o)= *((self)->r_ptr);__Buffer_Queue_IncPtr((self),(self)->r_ptr);}while(0)
